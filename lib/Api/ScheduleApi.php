...
class ScheduleApi
{
     ...
     */
    public function createScheduleRequest($body)
    {
     ...
     * @param  \Ebay\Sell\Feed\Model\UpdateUserScheduleRequest $body In the request payload: scheduleName is optional; preferredTriggerHour, preferredTriggerDayOfWeek, preferredTriggerDayOfMonth, scheduleStartDate, scheduleEndDate, and schemaVersion are conditional. (required)
     *
     * @throws \Ebay\Sell\Feed\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateScheduleRequest($schedule_id, $body)
    {
        // verify the required parameter 'schedule_id' is set
        if ($schedule_id === null || (is_array($schedule_id) && count($schedule_id) === 0)) {
            throw new \InvalidArgumentException(
