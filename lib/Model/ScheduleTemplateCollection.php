...
class ScheduleTemplateCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'schedule_templates' => '\Ebay\Sell\Feed\Model\ScheduleTemplateResponse[]',
        'total' => 'int'
    ];
     ...
     *
     * @return \Ebay\Sell\Feed\Model\ScheduleTemplateResponse[]|null
     */
     ...
     *
     * @param \Ebay\Sell\Feed\Model\ScheduleTemplateResponse[]|null $schedule_templates An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
