...
class InventoryTaskApi
{
     ...
     *
     * @param  \Ebay\Sell\Feed\Model\CreateInventoryTaskRequest $body The request payload containing the version, feedType, and optional filterCriteria. (required)
     ...
     * @return void
     */
    public function createInventoryTask($body, $x_ebay_c_marketplace_id = null)
    {
        $this->createInventoryTaskWithHttpInfo($body, $x_ebay_c_marketplace_id);
    }
     ...
     */
    public function createInventoryTaskWithHttpInfo($body, $x_ebay_c_marketplace_id = null)
    {
        $request = $this->createInventoryTaskRequest($body, $x_ebay_c_marketplace_id);
     ...
     */
    public function createInventoryTaskAsync($body, $x_ebay_c_marketplace_id = null)
    {
        return $this->createInventoryTaskAsyncWithHttpInfo($body, $x_ebay_c_marketplace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInventoryTaskAsyncWithHttpInfo($body, $x_ebay_c_marketplace_id = null)
    {
        $returnType = '';
        $request = $this->createInventoryTaskRequest($body, $x_ebay_c_marketplace_id);
     ...
     */
    public function createInventoryTaskRequest($body, $x_ebay_c_marketplace_id = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createInventoryTask'
            );
        }
