...
class CustomerServiceMetricTaskApi
{
     ...
     * @param  \Ebay\Sell\Feed\Model\CreateServiceMetricsTaskRequest $body Request payload containing version, feedType, and optional filterCriteria. (required)
     *
     ...
     */
    public function createCustomerServiceMetricTaskRequest($accept_language, $body)
    {
